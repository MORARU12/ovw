...
const TermsPage = () => {
  return (
    <div className="gradient-page-plh">
      <div className="page-icon terms"></div>
      <h1>
        Privacy policy <span>Terms & conditions</span>
      </h1>
      <p className="intrro-ft">Terms & Conditions</p>
      ...
      <p className="simple-ft">
        Ownvibe is committed to ensuring that the app is as useful and efficient
      ...
      <p className="simple-ft">
        The Ownvibe app stores and processes personal data that you have
        ...
        phone’s security features and it could mean that the Ownvibe app won’t
        work properly or at all.
      </p>

      <p className="simple-ft">
        You should be aware that there are certain things that Ownvibe will not
        ...
        or provided by your mobile network provider, but Ownvibe cannot take
      ...
      <p className="simple-ft">
        Along the same lines, Ownvibe cannot always take responsibility for the
        ...
        the Service, Ownvibe cannot accept responsibility.
      </p>

      <p className="simple-ft">
        With respect to Ownvibe’s responsibility for your use of the app, when
        ...
        it available to you. Ownvibe accepts no liability for any loss, direct
      ...
      <p className="simple-ft">
        ...
        keep using the app. Ownvibe does not promise that it will always update
      ...
      <p className="intrro-ft">Changes to This Terms and Conditions</p>
      ...
      <p className="simple-ft">
        These terms and conditions are effective as of 2021-08-12
      </p>

      <p className="intrro-ft">Contact Us</p>

      <p className="simple-ft">
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at ownvibe.app@gmail.com.
      </p>

      <p className="intrro-ft">Privacy Policy</p>

      <p className="simple-ft">
        Ownvibe built the Ownvibe app as a Free app. This SERVICE is provided by
        Ownvibe at no cost and is intended for use as is.
      </p>
      ...
      <p className="simple-ft">
        ...
        Terms and Conditions, which is accessible at Ownvibe unless otherwise
        defined in this Privacy Policy.
      </p>

      <p className="intrro-ft">Information Collection and Use</p>
      ...
      <p className="intrro-ft">Log Data</p>
      ...
      <p className="intrro-ft">Cookies</p>
      ...
      <p className="intrro-ft">Service Providers</p>
      ...
      <p className="simple-list-ft">
        <span className="ft">1. </span>To facilitate our Service;
      </p>
      <p className="simple-list-ft">
        <span className="ft">2. </span>First name and last name
      </p>
      <p className="simple-list-ft">
        <span className="ft">3. </span>To provide the Service on our behalf;
      </p>
      <p className="simple-list-ft">
        <span className="ft">4. </span>To perform Service-related services; or
      </p>
      <p className="simple-list-ft">
        <span className="ft">5. </span>To assist us in analyzing how our Service
        is used.
      </p>
      ...
      <p className="intrro-ft">Security</p>
      ...
      <p className="simple-ft ty">
        <span className="ft">Links to Other Sites </span>
      </p>
      ...
      <p className="intrro-ft">Children’s Privacy</p>
      ...
      <p className="intrro-ft">Changes to This Privacy Policy</p>
      ...
      <p className="simple-ft">This policy is effective as of 2022</p>
    </div>
  );
};
